...
export function chunkText(text, options = {}) {
    const { chunkSize = DEFAULT_CHUNK_SIZE, chunkOverlap = DEFAULT_CHUNK_OVERLAP, sourcePath = 'unknown', sessionKey, metadata, } = options;
 ...
 * 調整切塊邊界，優先在自然斷點處切分
 */
function adjustChunkBoundary(chunk, fullText, startOffset, endOffset) {
    // 如果已經到達文本末尾，不需要調整
